...
Namespace Context
    Public Class ExcelContextProvider
        ...
        Private Function BuildWorksheetInventory() As JArray
            ...
            Try
                ...
                For index = 1 To sheetCount
                    ...
                    Finally
                        ExcelAgent.Core.ComObjectHelper.ReleaseComObject(columns)
                        ExcelAgent.Core.ComObjectHelper.ReleaseComObject(rows)
                        ExcelAgent.Core.ComObjectHelper.ReleaseComObject(usedRange)
                        ExcelAgent.Core.ComObjectHelper.ReleaseComObject(sheet)
                    End Try
                Next
            ...
            Catch
                Return inventory
            Finally
                ExcelAgent.Core.ComObjectHelper.ReleaseComObject(worksheets)
                ExcelAgent.Core.ComObjectHelper.ReleaseComObject(workbook)
            End Try
            Return inventory
        End Function
        ...
        Private Function GetAdjacentTableColumnCell(worksheet As Excel.Worksheet,
            ...
            Finally
                ExcelAgent.Core.ComObjectHelper.ReleaseComObject(tableRange)
            End Try
        End Function
